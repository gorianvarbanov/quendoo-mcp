...
# Register tools defined from the OpenAPI spec
register_property_tools(server, client)
register_availability_tools(server, client)
register_booking_tools(server, client)
